...
$lang = array_merge($lang, array(
	...
	'ACP_QUICKREPLY_EXPLAIN'               => 'Paramètres généraux',
	...
	'ACP_QUICKREPLY_QN_EXPLAIN'            => 'Paramètres de la citation rapide & de la mention rapide',
	...
	'ACP_QUICKREPLY_PLUGINS_EXPLAIN'       => 'Paramètres supplémentaires',
	...
	'ACP_QR_FORM_TYPE_FIXED'               => 'Superposé',
	'ACP_QR_FORM_TYPE_SCROLL'              => 'Superposé, avec rechargement des messages', // reserved
	'ACP_QR_FORM_TYPE_STANDARD'            => 'Standard, affiché en bas de page',
	...
	'ACP_QR_FULL_QUOTE_EXPLAIN'            => 'Permet de modifier le comportement par défaut du bouton « Répondre en citant le message ».',
	...
	'ACP_QR_LAST_QUOTE_EXPLAIN'            => 'Permet les citations complètes au moyen du bouton de citation standard.<br /><em>NOTE : ce bouton de citation sera masqué si ce paramètre est désactivé ainsi que le paramètre de la citation rapide. Ce paramètre substitue le paramètre utilisateur de la citation complète.</em>',
	'ACP_QR_LEAVE_AS_IS'                   => 'Laisser tel quel',
	'ACP_QR_LEAVE_AS_IS_EXPLAIN'           => 'Permet de ne pas modifier les paramètres de chaque forum <em>si l’option « Laisser tel quel » est sélectionnée.</em>',
	...
	'ACP_QR_QUICKNICK_EXPLAIN'             => 'Permet d’afficher un menu déroulant au moyen du lien « Se référer au nom d’utilisateur » insérant automatiquement le nom d’utilisateur du message dans le formulaire de la réponse rapide. Ce menu déroulant s’affiche lorsque l’on clique sur le nom d’utilisateur dans le mini-profil et permet d’effectuer plusieurs actions, telles que « Voir le profil » de l’utilisateur, « Se référer au nom d’utilisateur » dans le formulaire de la réponse rapide et « Répondre dans un MP » si l’option est activée.<br />Si ce paramètre est activé et que le paramètre « Activer la mention rapide (située sous l’avatar) » est désactivé l’utilisateur peut basculer vers la version du lien « Se référer au nom d’utilisateur » situé sous l’avatar dans le « Panneau de l’utilisateur ».',
	...
	'ACP_QR_QUICKNICK_REF_EXPLAIN'         => 'Permet d’utiliser le BBCode [ref] en lieu et place du BBCode [b] pour la fonctionnalité « Se référer au nom d’utilisateur ».<br /><em>NOTE : si cette option est désactivée, les utilisateurs recevront uniquement des notifications concernant les mentions et seulement lorsque le BBCode [ref] aura été saisi manuellement dans un message.</em>',
